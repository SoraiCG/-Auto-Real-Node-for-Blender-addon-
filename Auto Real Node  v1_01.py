...
class SimpleOperator(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        Color1.color_ramp.elements[0].position = 0
        Color1.color_ramp.elements[1].position = 0.829

        Color2.color_ramp.elements[0].position = 0.127
        Color2.color_ramp.elements[1].position = 0.277
